        ...
        <TableAction
          :actions="[
            ...
            },
            {
              ...
              popConfirm: {
                title: '确认删除？',
                confirm: deleteDepartmentAction.bind(null, record.id),
              },
            },
          ]"
        />
...
<script lang="ts">
  ...
  import Modal from './components/CreateDepartment.vue';
  import {
    getDepartmentList,
    changeDepartmentState,
    deleteDepartment,
  } from '/@/api/manage/department';
